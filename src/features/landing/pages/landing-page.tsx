...
export function LandingPage() {
  ...
  return (
    <section className="grid gap-5 lg:min-h-[calc(100vh-15rem)] lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
      <div className="brand-panel overflow-hidden">
        <div className="grid h-full gap-8 p-6 sm:p-8 lg:p-10">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="rounded-[calc(var(--radius)-2px)] border border-border bg-card p-4">
              <p className="section-label">{t('home.verifiedTitle')}</p>
              <p className="mt-2 text-sm leading-7 text-muted-foreground">
                {t('home.verifiedCopy')}
              </p>
            </div>
            <div className="rounded-[calc(var(--radius)-2px)] border border-border bg-[color:var(--hc-surface)] p-4">
      ...
      <div className="overflow-hidden rounded-[calc(var(--radius)+6px)] border border-border bg-card shadow-[0_24px_50px_rgba(73,55,38,0.08)]">
        <img
